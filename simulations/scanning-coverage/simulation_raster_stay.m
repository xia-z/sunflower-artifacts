...
amplitudes = [0.05; 0.02; 0.02];
wave_number = 2*3.14*[1/0.3; 1/0.1; 1/0.11]; %2pi/lambda
f = [0.5;1.2;1.4];
T = 1./f;
% % speeds V = lambda*f
incident_points = [0,0,0];
speeds = 2*3.14*[f(1);f(2);f(3)];  %2pi*f
